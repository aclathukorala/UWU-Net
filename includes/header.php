<div class="header">
     <div class="container">
         <div class="logo">
             <a href="index.php"><h1>Uva Wellassa University Nature Explorers's Team</h1></a>
         </div>
         <div class="top-menu">
             <ul>
			 ...
			 <li><a href="gallary.php"><span class="glyphicon glyphicon-tags" aria-hidden="true"></span>Gallary</a></li>
             <li><a href="events.php"><span class="glyphicon glyphicon-tags" aria-hidden="true"></span>Events</a></li>
