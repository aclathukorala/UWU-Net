...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>       
        <title>Uva Wellassa University Nature Explorers's Team  - Login Page</title>
                ...
                <div class="bg-image" style="background-image: url('assets/img/photos/photo34@2x.jpg');">
                    <div class="row mx-0 bg-black-op">
                        <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                            ...
                            <a href="http://localhost/uwu_net/odms/index.php"><p class="font-size-h3 font-w600 text-white">
                                Uva Wellassa University Nature Explorers's Team.
                                </p></a>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="login.php">
                                        ...
                                        <a href="http://localhost/uwu_net/odms/index.php"><span class="font-size-xl">Uva Wellassa University Nature Explorers's Team </span></a>
                                    </a>
                                    <h1 class="h3 font-w700 mt-30 mb-10">Welcome to Uva Wellassa University Nature Explorers's Team Dashboard</h1>
