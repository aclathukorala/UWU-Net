                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">UWU</span><span class="font-size-xl text-primary">NET</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
...
{               ?>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a  href="addevent.php"><i class="si si-vector"></i><span class="sidebar-mini-hide">Add Our Organize Events </span></a>
                                 
                                </li>
                                <li>
                                    <a  href="addimages.php"><i class="si si-vector"></i><span class="sidebar-mini-hide">Add images to gallery </span></a>
                                 
                                </li>
                               
                               
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-energy"></i><span class="sidebar-mini-hide">Type of organize Events</span></a>
                                    <ul>
                                        <li>
